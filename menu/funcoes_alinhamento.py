...
def carregar_e_limpar_r3_consolidado(path):
    """
    Carrega e limpa os dados do sensor R3 a partir de um arquivo consolidado.
    Usa apenas as colunas do sensor 3.
    
    Parâmetros:
    - path: Caminho para o arquivo CSV consolidado
    
    Retorna:
    - DataFrame limpo com colunas padronizadas: SpO2, PR, Pi, Epoch
    """
    df = pd.read_csv(path)
    # Selecciona as colunas relevantes do sensor 3
    df_r3 = df[[
        'SpO2_%_Value_3', 
        'PR_bpm_Value_3', 
        'Pi_Value_3',
